                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                ...
                                <p class="category">Here is all the request</p>
                            </div>
                                    ...
                                    <tbody>
                                        <?php $i=1;foreach($requests as $request){ ?>
                                            <tr>
                                                ...
                                                <td><a href="<?php echo base_url('provider/accept_request/'.$request->id_request); ?>" class="btn btn-sm btn-success btn-icon"><i class="fa ti-shift-right"></i></a></td>
                                            </tr>
                                    <?php $i++;} ?>
                                    </tbody>
                                </table>
